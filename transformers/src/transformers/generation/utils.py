...
class GenerationMixin:
    ...
    def _prepare_cache_for_generation(
        ...
        # requires_cross_attention_cache = False
        requires_cross_attention_cache = (
            self.config.is_encoder_decoder or model_kwargs.get("encoder_outputs") is not None
        )
    ...
    def generate(
        ...
        **kwargs,
        ...
        # split max_new_tokens param to generation_config
        generation_config, model_kwargs = self._prepare_generation_config(generation_config, **kwargs)
        # not change model_kwargs
        self._validate_model_kwargs(model_kwargs.copy())
        # not infer, assistant_model=None
        ...
        # inputs = None, return input_ids tensor/input_ids/remain keys and values
        ...
        # update generation_config with /bos/eos/pos tensor
        ...
        # stopping_criteria = [], tokenizer = None
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        # judge depend on this_peer_finished
        while self._has_unfinished_sequences(
            this_peer_finished, synced_gpus, device=input_ids.device, cur_len=cur_len, max_length=max_length
        ):
            # prepare model inputs
            # cls Qwen2VLForConditionalGeneration method
            # add postion embeddings and change input_ids
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs)
