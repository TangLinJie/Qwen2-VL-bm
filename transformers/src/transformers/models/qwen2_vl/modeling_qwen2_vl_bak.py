...
class Qwen2VLAttention(nn.Module):
    ...
    def forward(
        ...
        kv_seq_len = key_states.shape[-3] # [-2]
...
class Qwen2VLModel(Qwen2VLPreTrainedModel):
    ...
    def forward(
        ...
        if position_ids is None:
            ...
            position_ids = position_ids.unsqueeze(0).view(-1, seq_length).view(1, 1, -1).expand(3, inputs_embeds.shape[0], -1)
        else:
            position_ids = position_ids.view(-1, seq_length).long().view(1, 1, -1).expand(3, inputs_embeds.shape[0], -1)
